  ...
  return (
    <footer id="main-footer" className="bg-[#0A0A0A] border-t border-[#222222] text-[#A0A0A0] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-8">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <p className="text-sm text-[#8E8E8E] leading-relaxed max-w-sm">
              ...
              through verifiable electronic consent artifacts.
            </p>

            <div className="pt-2 flex flex-wrap items-center gap-2">
              <span className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-[#141414] border border-[#262626] text-xs font-mono-code text-[#C0C0C0]">
              ...
              {demoScreens.map((screen) => (
                <li key={screen.id}>
                  ...
                  >
                    ...
                    <span className="text-[11px] font-mono-code text-[#777777] block mt-0.5">
                      {screen.role}
                    </span>
                  </button>
                </li>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-xs font-mono-code text-[#888888]">
              ...
              <li className="flex items-center justify-between py-1 border-b border-[#1E1E1E]">
                <span>GATEWAY</span>
                <span className="text-[#CCCCCC]">mTLS + OAuth2 Bearer</span>
              </li>
              <li className="flex items-center justify-between py-1 border-b border-[#1E1E1E]">
                <span>CONSENT ARTIFACT</span>
                <span className="text-[#CCCCCC]">ReBIT / MeitY Specs</span>
              </li>
              <li className="flex items-center justify-between py-1 border-b border-[#1E1E1E]">
                <span>AUDIT ENCRYPTION</span>
                <span className="text-[#CCCCCC]">SHA-256 Merkle Chain</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        {/* Bottom Bar */}
        <div className="mt-12 pt-6 border-t border-[#1C1C1C] flex flex-col sm:flex-row items-center justify-between gap-4 text-xs font-mono-code text-[#666666]">
          <div className="flex items-center gap-2">
            <span className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse"></span>
            <span>USDX PROTOCOL TESTNET // NODE CLUSTER IN-DELHI-01 ONLINE</span>
          </div>
          <p>© {new Date().getFullYear()} USDX — Unified Sports Data Exchange Initiative. Designed for Indian Sports Ecosystem.</p>
        </div>
      </div>
    </footer>
  );
